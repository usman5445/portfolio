...
export default function About() {
  ...
  useEffect(() => {
    ...
    VanillaTilt.init(containerRef.current, { scale: 1 });
    return () => {
      typed.destroy();
    };
  }, []);
  return (
    <div
      ref={containerRef}
      className=" relative grid h-4/5 w-full grid-cols-2 content-center items-center rounded-2xl border-2  border-white/60 bg-white/20 px-8 backdrop-blur-2xl "
    >
